...
const rows = [
    createData('Стяжка пола без подготовки','9 руб./м²', '-'),
    createData('Стяжка пола с армирующим волокном', '11 руб./м²', '-'),
    createData('Подготовка из пенополистерола', '3 руб./м²', '-'),
    createData('Подготовка из руллоных материалов(пленка/стенофон)', '1 руб./м²', '-'),
